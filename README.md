...
从这一过程来看，我们发现可以把关注点放到小白鼠身上了。为了能最大限度地去压缩试管信息，我们是否能对小白鼠的生死状态来映射为哪一根试管有毒呢？答案是肯定的。正因为老鼠喝了试剂后只有两种状态——生或死，我们不妨把生用 **0** 表示；把死用 **1** 来表示。因为有毒试剂就1根，所以生的几率非常大，因而把死亡状态设置为最终的目标状态。所以，对于3只小白鼠而言，可将其视作为 **3个比特**。于是可获得以下真值表：
